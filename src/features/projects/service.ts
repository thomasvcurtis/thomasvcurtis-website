...
import weatherBoxImage from '@/assets/weather-box.webp';
import type {
  ProjectData,
  SkillData,
  TranslatedProject,
...
const projectsListUnsorted: Array<ProjectData> = [
  {
    ...
    projectUrl: 'https://weather-box-b26bb.web.app/',
    codeUrl: 'https://github.com/thomasvcurtis/weather-box-2.0',
    tags: ['React', 'TypeScript', 'Vite', 'Firebase', 'Mapbox', 'Tomorrow.io'],
    ...
    technologiesUsed: [
      ...
      { id: 'tomorrowio', name: 'Tomorrow.io' },
    ],
  },
];
...
function translateProject(
  ...
  const galleryImagesTranslated = project.galleryImages?.map((gi) => ({
    ...gi,
    alt: `Image ${gi.id} for Weather Box`,
    caption: '',
  })) ?? [];
